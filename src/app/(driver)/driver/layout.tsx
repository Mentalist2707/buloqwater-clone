    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 shadow-lg safe-bottom z-40">
        <div className="flex items-center justify-around max-w-lg mx-auto py-2">
          <a href="/driver/tasks" className="flex flex-col items-center gap-0.5 py-1 px-4 text-primary-600">
            <span className="text-xl">📋</span>
            <span className="text-[10px] font-bold">Vazifalar</span>
          </a>
          <form action="/api/auth/signout" method="POST">
            <button type="submit" className="flex flex-col items-center gap-0.5 py-1 px-4 text-gray-400 hover:text-red-500">
              <span className="text-xl">🚪</span>
