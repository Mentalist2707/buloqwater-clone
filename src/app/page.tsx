  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-gray-900">BuloqWater</span>
          </Link>
      ...
      <section className="pt-28 pb-16 sm:pt-36 sm:pb-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-50 text-primary-700 text-xs font-medium mb-6">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-8">
                ...
                <Link href="/login" className="px-6 py-4 text-base font-medium text-gray-700 hover:text-gray-900 border border-gray-200 rounded-2xl hover:bg-gray-50 transition-all">
                  Tizimga kirish
                </Link>
              </div>
              {/* Stats */}
              <div className="flex items-center gap-8 mt-12 pt-8 border-t border-gray-100">
                <div><p className="text-2xl font-bold text-gray-900">500+</p><p className="text-xs text-gray-500">Doimiy mijozlar</p></div>
                <div><p className="text-2xl font-bold text-gray-900">10,000+</p><p className="text-xs text-gray-500">Yetkazilgan buyurtmalar</p></div>
                <div><p className="text-2xl font-bold text-gray-900">24/7</p><p className="text-xs text-gray-500">Xizmat ko&apos;rsatish</p></div>
              </div>
            </div>
            {/* Hero Image */}
            <div className="relative hidden lg:block">
              ...
              <div className="absolute -left-6 top-1/4 bg-white rounded-2xl shadow-xl p-4 border border-gray-100 animate-bounce" style={{ animationDuration: "3s" }}>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-lg">✅</div>
                  <div><p className="text-xs text-gray-500">Yangi buyurtma</p><p className="text-sm font-semibold">Yetkazildi!</p></div>
                </div>
              </div>
              <div className="absolute -right-4 bottom-1/4 bg-white rounded-2xl shadow-xl p-4 border border-gray-100 animate-bounce" style={{ animationDuration: "4s" }}>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center text-lg">🚚</div>
                  <div><p className="text-xs text-gray-500">Haydovchi</p><p className="text-sm font-semibold">Yo&apos;lda...</p></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-24 bg-gray-50 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">Nima uchun biz?</h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">BuloqWater — suv yetkazib berish sohasidagi eng zamonaviy platforma</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-all hover:-translate-y-1">
      ...
      <section className="py-16 sm:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">Qanday ishlaydi?</h2>
            <p className="text-gray-500 mt-3">Faqat 3 ta oson qadam</p>
          </div>
      ...
      <footer className="border-t border-gray-100 py-8 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-gray-700">BuloqWater</span>
          </div>
          <p className="text-xs text-gray-400">&copy; 2024 BuloqWater. Barcha huquqlar himoyalangan.</p>
          <div className="flex items-center gap-4">
            <Link href="/login" className="text-xs text-gray-500 hover:text-gray-700">Kirish</Link>
            <Link href="/register" className="text-xs text-gray-500 hover:text-gray-700">Ro&apos;yxatdan o&apos;tish</Link>
          </div>
        </div>
      </footer>
    </div>
